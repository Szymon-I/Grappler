...
// ----------------------------------------------------------------------------------
void RenderText(std::string text, float x, float y, float scale = 1.0f, glm::vec3 color = glm::vec3(1.0, 1.0, 1.0), glm::mat4x4 Matrix_proj_mv = glm::mat4x4( 1.0 ))
{
    glEnable(GL_BLEND);
    ...
    glUniformMatrix4fv( glGetUniformLocation( text_program, "Matrix_proj_mv" ), 1, GL_FALSE, glm::value_ptr(Matrix_proj_mv) );
